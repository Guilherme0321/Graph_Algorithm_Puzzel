...
namespace graph_algorithm.Support {
    ...
    public class Veiculo
    {
        ...
        public Veiculo(string id,int x, int y, int length, Direction direction, bool isObstacle)
        {
        ...
        public bool EqualsPosition(Veiculo obj)
        {
            return this.pos.Item1 == obj.pos.Item1 && this.pos.Item2 == obj.pos.Item2;
        }

        public Veiculo MoveHorizontally(int movimentacao, MoveHorizontal direcao)
        {
            int y = pos.Item2 + (direcao == MoveHorizontal.Esquerda ? -movimentacao : movimentacao);
            return new Veiculo(this.id, this.pos.Item1, y, this.length, this.direction, this.IsObstacle);
        }

        public Veiculo MoveVertically(int movimentacao, MoveVertical direcao)
        {
            int x = pos.Item1 + (direcao == MoveVertical.Cima ? -movimentacao : movimentacao);
            return new Veiculo(this.id, x, this.pos.Item2, this.length, this.direction, this.IsObstacle);
        }
        ...
        public bool HadColision(Veiculo v2)
        {
        ...
        {
            return new Veiculo(id, pos.Item1, pos.Item2, length, direction, isObstacle);
        }

        private bool Equal(Veiculo obj)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equal((Veiculo)obj);
        }

        public static bool operator ==(Veiculo i, Veiculo j)
        {
